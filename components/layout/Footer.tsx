      ...
      <div className="mx-auto max-w-7xl px-6 py-10 md:py-24">
        ...
        <div className="grid grid-cols-1 gap-10 md:grid-cols-12 lg:gap-16">
          ...
          <div className="md:col-span-5 lg:col-span-4 flex flex-col items-start">
            ...
            <p className="font-outfit text-[10px] tracking-[0.2em] uppercase text-[#D4A46A] mb-6">
              @ Viaan Enclave
            </p>
          ...
          <div className="md:col-span-7 lg:col-span-8 grid grid-cols-2 gap-8 sm:grid-cols-3">
            
            {/* Quick Links */}
            <div className="col-span-1">
              <p className="font-outfit text-xs font-semibold uppercase tracking-[0.15em] text-white mb-4 md:mb-6">
                Navigation
              </p>
            ...
            {/* CTA / Social */}
            <div className="col-span-2 sm:col-span-1 mt-2 sm:mt-0 pt-6 sm:pt-0 border-t border-white/5 sm:border-0">
              <p className="font-outfit text-xs font-semibold uppercase tracking-[0.15em] text-white mb-4 md:mb-6">
                Get In Touch
              </p>
              <div className="flex flex-col gap-3">
                <a
                  href={`https://wa.me/${process.env.NEXT_PUBLIC_WHATSAPP_NUMBER ?? '916361512031'}`}
                  target="_blank"
                ...
                <a
                  href={`https://wa.me/${process.env.NEXT_PUBLIC_WHATSAPP_NUMBER_2 ?? '919739775328'}`}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group inline-flex items-center gap-2 rounded-sm border border-[#25D366]/30 bg-[#25D366]/10 px-4 py-2.5 transition-all hover:bg-[#25D366] hover:border-[#25D366]"
                >
                ...
                <div className="mt-2 flex flex-col gap-1 font-outfit text-[11px] text-white/50">
                  <a href="mailto:shettysrikrishna@gmail.com" className="hover:text-[#D4A46A] transition-colors">shettysrikrishna@gmail.com</a>
        ...
        {/* Divider */}
        <div className="my-8 md:my-12 h-[1px] w-full bg-white/5" />
